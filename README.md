...
### Borderless
italo can be used by anyone with access to the internet.

### Oracle Clusters
italo is a hybrid PoW/PoS decentralized oracle node network

### High Utility 
Use-cases span from stablecoins to eSports

### For announcements:
[Website](https://italo.network)
[Twitter](https://twitter.com/italoCC)  
[Discord](https://discord.gg/pDyfUTs)


# General Information
Copyright (c) 2014-2019 The Monero Project.   
Copyright (c) 2018-2019 Project Italo/italo.
...
`$ git clone --recursive https://github.com/italoCC/italo.git italo`
...
* Add `PATH="$PATH:$HOME/italo/build/Linux/release/bin"` to `.profile`

* Run italo with `daemond --detach`
